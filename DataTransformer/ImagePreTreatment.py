...
def parse_opt():
    ...
    parser.add_argument('--path', type=str,default=r'C:\Users\SAR\Desktop\作业或工作论文汇报与ppt\工作\做项目\国家重点研发计划\川藏线目标识别\矢量化示例\影像下载_2112072113\19\tif', metavar='', help='图像路径')
    parser.add_argument('--kernel', type=int, default=[512,512],nargs='+', metavar='', help='裁剪图像大小')
    parser.add_argument('--stride', type=int,default=512, metavar='', help='裁剪步长')
    parser.add_argument('--nodata', type=int, default=0, metavar='', help='nodata')
    parser.add_argument('--sifer', type=float,default=0.5, metavar='', required=False,help='过滤背景占比大于一定阈值的图像')
    parser.add_argument('--save_path', type=str,default=r'C:\Users\SAR\Desktop\git_push\SWJTU-GXL Team\Datagenerater\test', metavar='', help='图像保存路径')
    parser.add_argument('--save_name', type=str, default='cut',metavar='', help='图像保存名称')
