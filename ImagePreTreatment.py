...
def parse_opt():
    ...
    parser.add_argument('--path', type=str,default=r'C:\Users\SAR\Desktop\test (2)', metavar='', help='图像路径')
    parser.add_argument('--kernel', type=int, default=[512,512],nargs='+', metavar='', help='裁剪图像大小')
    parser.add_argument('--stride', type=int,default=100, metavar='', help='裁剪步长')
    ...
    parser.add_argument('--save_path', type=str,default=r'C:\Users\SAR\Desktop\test (2)\xxx', metavar='', help='图像保存路径')
